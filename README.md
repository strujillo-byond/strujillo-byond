...
<!-- Stats card served from a community mirror while the official instance
     (github-readme-stats.vercel.app) is DEPLOYMENT_PAUSED — swap the host
     back to the official one when it comes back up. -->
